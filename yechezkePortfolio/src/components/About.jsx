        ...
        <div className="row gy-5">
          ...
          <div className="col-lg-7 col-xl-8 text-center text-lg-start">
            ...
            <p className={darkTheme ? "text-white-50" : ""}>
              I am a GITOPS software engineering student in my fourth year of studies, with one year of hands-on experience in DevOps.
          ...
          <div className="col-lg-5 col-xl-4">
            <div className="ps-lg-4">
              ...
              >
                <li>
                  <span className="fw-600 me-2">Name:</span>Chay Fadida
                </li>
                <li>
                  <span className="fw-600 me-2">Email:</span>
                  <a href="mailto:chayfadida1997@gmail.com">chayfadida1997@gmail.com</a>
                </li>
                <li>
